...
export default function AboutUs() {
  return <div className="w-full mt-20 relative h-full px-16 my-8">
    ...
    <div className="absolute px-16 m-auto top-0">
      ...
      سلام! به عبید خوش اومدی! اینجا جاییه که میتونی کلی بخندی و حال کنی. ما یه سایت باحالیم که توش میتونی جوک های خنده دارت رو با بقیه به اشتراک بذاری و به جوک های بقیه واکنش نشون بدی.
      </p>
    </div>
  </div>
}